...
echo Unreal Engine Clang Database Generator
echo =====================================
echo.
...
call "!UE_DIR!\Engine\Build\BatchFiles\Build.bat" -mode=GenerateClangDatabase -project "!UPROJECT_PATH!" -game -engine !UPROJECT_NAME!Editor Win64 Development

REM Move compile_commands.json from UE folder to project folder
set UE_COMPILE_COMMANDS="!UE_DIR!\compile_commands.json"
set PROJECT_COMPILE_COMMANDS="!PROJECT_DIR!compile_commands.json"

if exist !UE_COMPILE_COMMANDS! (
    echo Moving compile_commands.json to project directory...
    move !UE_COMPILE_COMMANDS! !PROJECT_COMPILE_COMMANDS!
) else (
    echo WARNING: compile_commands.json not found at: !UE_COMPILE_COMMANDS!
)
